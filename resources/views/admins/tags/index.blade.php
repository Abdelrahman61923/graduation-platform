            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="display dataTable" id="TagTable">
                    <thead>
                      <tr>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            let dataTableUrl = "{{ route('tags.get') }}";
            let columns = [
                {
                    data: 'id',
                    visiable: false
            ...
            let Buttons = [
                {
                    ...
                    attr: {
                        'onclick': "Redirect('{{ route('tags.create') }}')",
            ...
            let columnDefs = [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        var route = "{{ route('tags.change-status', ':id') }}";
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        var url2 = "{{ route('tags.delete', ':id') }}";
                        url2 = url2.replace(':id', pk);
                        return (
                            '<div class="btn-group">' +
                                '<a class="btn btn-danger delete-confirm" table="TagTable" row="' + meta.row + '" data-url="' + url2 +'" >' +
            ...
            initDatatable(dataTableUrl, columns, columnDefs, 'TagTable', Buttons, order = [
                [0, "DESC"]
            ], responsive);
        });
    </script>
