...
@endsection
<input value="{{ $department->id }}" type="hidden" class="form-control" name="id" value="{{old('id')}}">
<div class="row">
    <div class="col-md-6">
        <label for="title">Name<span class="redstar">*</span></label>
        <input value="{{ old('name', $department->name) }}" class="form-control" type="text" name="name" placeholder="Please Enter Name">
        @if ($errors->has('name'))
