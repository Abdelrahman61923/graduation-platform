...
<div class="row">
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <textarea id="instruction" class="form-control shadow-none @error('instruction') is-invalid @enderror" name="instruction" value="{{ old('instruction') }}"
                autocomplete="instruction" placeholder="{{ __('Instruction') }}" autofocus>{{ old('instruction', $instruction->instruction) }}</textarea>
            @error('instruction')
