                        ...
                        <form class="card" method="POST" action="{{ route('profile.update') }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputUsername2" class="form-label">Last Name</label>
                                        <input type="text" name="last_name" class="form-control"
                                            id="exampleInputUsername2" autocomplete="off"
                                            value="{{ auth()->user()->last_name }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername4" class="form-label">Email</label>
                                        <input type="email" name="email" class="form-control" id="exampleInputUsername4"
                                            autocomplete="off" value="{{ auth()->user()->email }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername5" class="form-label">phone</label>
                                        <input type="text" name="phone" class="form-control"
                                            id="exampleInputUsername5" autocomplete="off"
                                            value="{{ auth()->user()->phone }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername6" class="form-label">Address</label>
                                        <input type="text" name="address" class="form-control"
                                            id="exampleInputUsername6" autocomplete="off"
                                            value="{{ auth()->user()->address }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername7" class="form-label">Photo</label>
