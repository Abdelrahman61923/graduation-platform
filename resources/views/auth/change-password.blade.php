...
<div class="page">
    ...
    <form action="{{ route('passwords.update') }}" method="POST" style="height: auto;">
        ...
        <div>
            ...
            <input id="old_password" type="password" class="form-control @error('old_password') is-invalid @enderror" placeholder="Old Password"  name="old_password" required autocomplete="old-password">
            @error('old_password')
